...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mark.is_laid'
        db.add_column('courses_mark', 'is_laid', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Mark.is_laid'
        db.delete_column('courses_mark', 'is_laid')
