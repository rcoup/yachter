...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.is_enabled'
        db.add_column('weather_source', 'is_enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.is_enabled'
        db.delete_column('weather_source', 'is_enabled')
